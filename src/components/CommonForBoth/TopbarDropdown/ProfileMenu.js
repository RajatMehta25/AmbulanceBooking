            ...
            <React.Fragment>
                        <Dropdown isOpen={this.state.menu} toggle={this.toggle} className="d-inline-block user-dropdown">
                            ...
                            <DropdownMenu right>
                                ...
                                {/* <DropdownItem href="/adminPanel/changePassword"><i className="ri-lock-unlock-line align-middle mr-1"></i> {this.props.t('Change Password')}</DropdownItem> */}
                                {/* <DropdownItem divider /> */}
                                <button className=" text-danger dropdown-item" href="#" onClick={()=> {
                                    Cookies.remove('admin_access_token');
                                    Cookies.remove('access');
                                    this.props.history.push('/login')
                                }}><i className="ri-shut-down-line align-middle mr-1 text-danger"></i> {this.props.t('Logout')}</button>
                            </DropdownMenu>
                        </Dropdown>
            </React.Fragment>
        );
