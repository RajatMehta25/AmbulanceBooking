...
const validationSchema = yup.object({
   ...
   name: yup.string().required("Name is Required!"),
    ...
    Rnumber: yup.string().min(10,"Minimum 10 digits required!").required("Registration Number is Required!"),
        ...
        <div className={classes.paperPaddingRightLeft}>
          <div className="py-4">
              ...
              <div className={classes.headingSellerDetails}>
                 ...
                 <div className={classNames(classes.addNewCategoryHeading)} > <h3 className={classNames(classes.MarginControl)} style={{marginBottom:"-0.5rem",marginLeft:"-135px"}}>{console.log(state)}{ !state?`ADD NEW USER`:`EDIT USER`}</h3></div>
      ...
      <Formik
        ...
        initialValues={{
          ...
          name:   get(state, "first_name", ""),
           Rnumber: get(state,"country_code", "") + get(state,"phone_number", ""),
...
<div className="row my-5">
  ...
  <label  className="" style={{fontSize:"18px"}}>User Name :</label>
  </div>
  <div className="col-lg-8">
  <Field style={{width:"100%",height:"35px",borderRadius:"5px",border:"1px solid #c4c4c4",paddingInlineStart:10}} className="fieldAddCategory" name="name" type="name"   />
...
<div className="row my-5">
  <div className="col-lg-4">
  <label  className="" style={{fontSize:"18px"}}>Phone Number :</label>
  </div>
  <div className="col-lg-8">
  <PhoneInput
  country={'us'}
...
{/* row 3 */}
{!state?<div className="row my-5">
  <div className="col-lg-4">
  <label  className="" style={{fontSize:"18px"}}>Email ID :</label>
  </div>
  <div className="col-lg-8">
  <Field style={{width:"100%",height:"35px",borderRadius:"5px",border:"1px solid #c4c4c4",paddingInlineStart:10}} className="fieldAddCategory" name="email" type="email"   />
...
<div className="row my-5">
  ...
  <div className="col-lg-8">
  <Field disabled style={{width:"100%",height:"35px",borderRadius:"5px",border:"1px solid #c4c4c4",paddingInlineStart:10}} className="fieldAddCategory" name="email" type="email"   />
<KErrorMessage name="email" />
</div></div>
...
<div className="row my-5">
  <div className="col-lg-4">
  <label  className="" style={{fontSize:"18px"}}>Password :</label>
  </div>
  <div className="col-lg-8 d-flex align-items-center">
  <Field style={{width:"100%",height:"35px",borderRadius:"5px",border:"1px solid #c4c4c4",paddingInlineStart:10}} className="fieldAddCategory" name="password" type={showpassword?"text":"password" }  />
  {showpassword? <Visibility   onClick={()=>setShowPassword(false)}/> :<VisibilityOff  onClick={()=>setShowPassword(true)}/>}
...
<div className="row my-5 align-items-center">
  <div className="col-lg-4">
  <label  className="" style={{fontSize:"18px"}}>Upload Image :</label>
  </div>
  <div className="col-lg-4">
  <input
                              ref={fileRef}
...
<div className="col-lg-4">         
{!state&&profileImagepath==="" &&( <WallpaperIcon  style={{ width: "100px", height: "100px" }}/>)}
 {
